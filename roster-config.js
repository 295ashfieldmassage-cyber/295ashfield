...
(function () {
  ...
  const weeklyNames = {
    monday: ["Kitty","Lucy","Lola", "Aria","Regina","Lulu","Sweet","Aya", "Andie","Angelina"],
    tuesday: ["Brooke","Lucy","Aria","Zuri","Lulu","Amy","Regina","Kitty","Andie","Sweet"],
    wednesday: ["Lucy","Regina","Rose","Zuri","Aria","Kitty" ,"larni","Angelina","Andie","Tia","Sweet", "Sasa","Venessa"],
    thursday: ["Lucy","Kitty","Zuri","Andie","Lulu","Venessa","Sasa","Tia","Rose", "Regina","Anna", "Sweet", "Sasa"],
    friday: ["Aya","Brooke","Zuri","Regina","Amy","Anna","Lucy","Tia","Rose", "Kitty","Lulu","Sweet", "Angel","Natalia","Angelina"],
    saturday: ["Kitty","Lucy","Aya","Dodo","Brooke","Natalia","Regina","Sweet","Anna", "Yoyo","Zuri"],
    sunday: ["Aya","Kitty","Brooke","Natalia","Tia","Rose","Lucy","Regina", "Anna","Zuri","Angelina","Rachel","Sasa","Yoyo","Lulu"]  };
