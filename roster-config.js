...
(function () {
  ...
  const weeklyNames = {
    monday: ["Kitty","Lucy","Lola", "Regina","Lulu","Sweet","Una","Aya", "Andie"],
    tuesday: ["Kitty","Venessa","Lucy","Regina","Rachel", "Una", "Andie","Sweet"],
    wednesday: ["Venessa","Aya","Regina","Rose","Kitty", "Angelina","Andie","Tia","Sweet", "Sasa"],
    thursday: ["Aya","Kitty","Tina","Andie","Lulu","Rachel","Tia","Venessa","Rose", "Regina","Anna", "Sweet", "Sasa"],
    friday: ["Aya","Regina","Anna","Tia","Rose", "Kitty","Lulu","Sweet","Rachel","Angelina", "Angel","Natalia"],
    saturday: ["Kitty","Natalia","Regina","Mira","Jolie", "Sweet", "Rachel","Anna", "Angelina","Aya"],
    sunday: ["Kitty","Natalia","Tia","Rose","Regina","Rachel", "Anna","Andie", "Aya", "Rachel","Sweet","Sasa"]
  };
