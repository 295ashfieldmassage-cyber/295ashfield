...
(function () {
  ...
  const weeklyNames = {
    monday: ["Kitty","Tiffany","Lucy", "Aria","Regina","Lulu","Sweet", "Andie"],
    tuesday: ["Brooke","Lucy","Aria","Zuri","Lulu","Amy","Regina","Kitty","Andie","Sweet"],
    wednesday: ["Lucy","Mico","Regina","Rose","Kitty" ,"Larni","Angelina","Andie","Tia","Sweet", "Sasa","Venessa"],
    thursday: ["Lucy","Kitty","Zuri","Andie","Lulu","Venessa","Sasa","Tia","Rose", "Regina","Anna", "Sweet", "Sasa"],
    friday: ["Aya","Lucy","Zuri","Regina","Anna","Tia","Rose", "Kitty","Lulu","Sweet", "Angel","Natalia","Angelina"],
    saturday: ["Kitty","Lucy","Aya","Dodo","Natalia","Lulu","Regina","Anna", "Yoyo","Zuri"],
    sunday: ["Aya","Natalia","Tia","Rose","Lucy","Lulu","Regina", "Anna","Zuri","Sasa","Yoyo"]  };
